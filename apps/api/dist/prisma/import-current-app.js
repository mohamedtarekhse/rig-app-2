...
async function main() {
    ...
    try {
        const [legacyClients] = await connection.query('SELECT * FROM clients ORDER BY id ASC');
        const [legacyUsers] = await connection.query('SELECT * FROM users ORDER BY id ASC');
